...
const content = {
  en: {
    ...
    hero: {
      ...
      titleA: 'I build',
      titleB: 'products.',
      intro: 'Ideas become software through hundreds of small decisions. I enjoy making the right ones.',
      ctaWork: 'Explore my work',
      ctaThink: 'See how I think',
      bottom: 'I build digital products that people enjoy using—from the first rough idea to software running in production.',
    },
    notes: {
  ...
  es: {
    ...
    hero: {
      ...
      titleA: 'Construyo',
      titleB: 'productos.',
      intro: 'Las ideas se convierten en software a través de cientos de pequeñas decisiones. Disfruto encontrar las correctas.',
      ctaWork: 'Ver mis proyectos',
      ctaThink: 'Ver cómo pienso',
      bottom: 'Construyo productos digitales que la gente disfruta usar, desde la primera idea hasta el software funcionando en producción.',
    },
    notes: {
