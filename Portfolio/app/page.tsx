...
const images = {
  ...
  filterfresh: '/filterfresh.png',
  lacremerie: '/lacremerie-carta.png',
  viandas: '/viandas-fitness.png',
...
const projectImages = [
  ...
  [images.pelotita],
  [images.harmonicaEvandr, images.harmonicaLuxe, images.harmonicaAgency, images.filterfresh, images.harmonicaTwoTails, images.harmonicaPenta],
...
const content = {
  en: {
    ...
    notes: {
      ...
      artifactLacremerie: 'LaCremerie — digital menu for an ice-cream shop',
      artifactViandas: 'Viandas Fitness — landing and weekly plans',
    ...
    craft: {
      ...
      processCopy: 'It is the process I always end up coming back to: six simple steps that keep me on track, with the nuances each project needs.',
      steps: [
      ...
      offerLabel: 'What I bring & the tools',
      groups: [
        { name: 'Build', offer: 'End-to-end development · Frontend & backend · Databases & auth · Integrations & automation' },
      ...
      hub: [
        ...
        { name: 'Product, design & delivery', items: [{ label: 'Notion' }, { label: 'Figma' }, { label: 'Jira' }, { label: 'Scrum' }, { label: 'Obsidian' }, { label: 'Slack' }] },
        { name: 'AI & exploration', items: [{ label: 'ChatGPT' }, { label: 'Claude' }, { label: 'Cursor' }, { label: 'MCP integrations' }, { label: 'LLM APIs' }, { label: 'WebSockets' }, { label: 'Realtime databases' }, { label: 'Three.js' }, { label: 'Game systems' }, { label: 'Leaflet' }, { label: 'OpenStreetMap' }] },
        { name: 'Ship & measure', items: [{ label: 'Lighthouse' }, { label: 'Google Analytics 4' }, { label: 'Search Console' }, { label: 'GitHub Actions' }, { label: 'Playwright' }, { label: 'Semrush' }] },
      ],
    },
    work: {
      ...
      projects: [
        { title: 'Avi Salud', type: 'Healthcare website & operations system', tags: ['Web', 'Systems', 'Healthcare'], statement: 'The same care experience, outside and inside the company.', body: 'With Estudio Ve, we built both the public website and an internal system for a home healthcare company in Mar del Plata. On the website we organized care plans, providers, benefits and educational content; the system centralizes appointments, routines, clients, employees and financial movements.', outcome: 'A clearer experience for families and a more organized operation for the team.', links: [{ label: 'avisalud.com.ar', href: 'https://www.avisalud.com.ar/' }] },
        ...
        { title: 'Pelotita', type: 'Football results & fantasy leagues', tags: ['Own product', 'Data', 'Scraping', 'SEO', 'AdSense'], statement: 'Organized football data, up-to-date results and fantasy leagues.', body: 'Pelotita gathers data from multiple sources, normalizes teams, tournaments and matches, and uses that foundation to power fantasy leagues between users. Behind it are scraping pipelines, SEO and automation tools for the news and blog. I also had to optimize quite a bit on the DevOps side — caching, queries and deploys — so nothing falls over as the data keeps growing.', outcome: 'A fast, reliable football platform with monetization considered as part of the product.', stats: ['10k+ matches processed', 'Multiple football data sources normalized', 'Fantasy leagues between users'], links: [{ label: 'live demo', href: 'https://pelotita-football-platform-three.vercel.app/' }] },
        { title: 'Harmonica', type: 'Product Engineer · Technical lead', tags: ['Leadership', 'WordPress', 'Shopify', 'Next.js', 'SEO'], statement: 'More than ten clients, more than ten businesses, and the entire responsibility on me.', body: 'At Harmonica I worked as a Product Engineer and took the technical lead on projects for more than ten clients. I built, maintained and improved everything from WordPress and Shopify stores to Next.js products across e-commerce, wellness, personal brands and corporate sites. I coordinated priorities, technical decisions and delivery while keeping several websites healthy at once. It was also my only project in English, so I learned the language as much as the tech.', outcome: 'I learned to lead, communicate with clients, enter unfamiliar stacks quickly and deliver without disrupting what was already working.', links: [{ label: 'katysaeger.co', href: 'https://www.katysaeger.co/' }, { label: 'harmonica.co', href: 'https://harmonica.co/' }, { label: 'evandr.co', href: 'https://www.evandr.co/' }, { label: 'twotailspetcompany.com', href: 'https://twotailspetcompany.com' }] },
        { title: 'Smithii', type: 'Web3 product ecosystem', tags: ['Frontend', 'Web3', 'Product', 'Scrum', 'Chakra UI', 'APIs'], statement: 'I built for a massive user base as a junior, and it was the project that taught me the most.', body: 'I spent almost two years inside a Web3 ecosystem that never stood still. I worked on public tools for creating tokens, liquidity, airdrops and more; the internal management software; and a staking builder that we launched as its own product. It meant a lot of frontend, blockchain integrations, countless APIs, high-volume usage and data flows that had to stay fast and reliable. We dealt with clients, setbacks included, and I also learned to work as part of a Scrum team, organize delivery in Jira and coordinate features end to end.', outcome: 'I learned to navigate complex products, optimize before problems surfaced and build as a team without losing sight of the user.', links: [{ label: 'smithii.io', href: 'https://smithii.io/' }, { label: 'stake.smithii.io', href: 'https://stake.smithii.io/' }] },
        { title: 'Claridad', type: 'Community safety map', tags: ['Maps', 'APIs', 'Hackathons', 'OpenStreetMap', 'WebSockets'], statement: 'A map for the neighborhoods of Mar del Plata.', body: 'In a small team, we built a collaborative safety product with geolocated reports, communities, real-time alerts and a panic button. It combined location data with multiple APIs; we took it to hackathons, tested it in public and kept iterating.', outcome: 'A useful civic product shaped through teamwork, APIs and fast iteration. It did not continue due to the company’s financial situation.' },
        { title: 'Stockeo', type: 'Inventory SaaS', tags: ['Next.js', 'Java', 'Mercado Pago'], statement: 'My first SaaS, built with my studio partner.', body: 'Stockeo started as a practical way for Estudio Ve to create recurring income. We built a Java backend, a Next.js frontend and Mercado Pago subscriptions around a simple inventory workflow for small businesses.', outcome: 'A solid SaaS foundation with product, payments and business decisions included.', links: [{ label: 'stockeo.app', href: 'https://www.stockeo.app/' }] },
        { title: 'Presidential Simulator', type: 'Independent game', tags: ['Game Design', 'Systems', 'TypeScript', 'Hobby'], statement: 'The game of my life and the strangest one.', body: 'A bizarre presidential game I am building among friends. It is a hobby, a creative outlet and a very large technical challenge where I am learning about game mechanics, collaboration, systems design and so many areas I am discovering I enjoy.', outcome: 'A place to experiment freely and learn things commercial work rarely teaches.' },
        { title: 'Busy', type: 'Streetwear brand', tags: ['E-commerce', 'SEO', 'Brand'], statement: 'My first business was one of the projects I learned the most from.', body: 'I created and ran a clothing brand end to end: the online store with integrated payments, the content, the APIs, the design and the events. I innovated in content and in how the brand showed up, and learned what it takes to run an e-commerce across both technology and business. Without a physical shop, Busy ranked for clothing searches in Mar del Plata and even appeared in AI search results.', outcome: 'Hands-on experience across business, integrations, payments, SEO, design and community.' },
      ],
    },
    growth: {
      eyebrow: '03 — Growth',
    ...
    about: {
      ...
      now: [
        { label: 'Stockeo', href: 'https://www.stockeo.app/' },
  ...
  es: {
    ...
    notes: {
      ...
      artifactLacremerie: 'LaCremerie — carta digital para una heladería',
      artifactViandas: 'Viandas Fitness — landing y planes semanales',
    ...
    craft: {
      ...
      processCopy: 'Es el proceso al que siempre termino volviendo: seis pasos simples que me ordenan, con los matices que pide cada proyecto.',
      steps: [
      ...
      offerLabel: 'Lo que aporto y las herramientas',
      groups: [
      ...
      hub: [
        ...
        { name: 'Producto, diseño y entregas', items: [{ label: 'Notion' }, { label: 'Figma' }, { label: 'Jira' }, { label: 'Scrum' }, { label: 'Obsidian' }, { label: 'Slack' }] },
        { name: 'IA y exploración', items: [{ label: 'ChatGPT' }, { label: 'Claude' }, { label: 'Cursor' }, { label: 'MCP integrations' }, { label: 'APIs de LLMs' }, { label: 'WebSockets' }, { label: 'Bases de datos realtime' }, { label: 'Three.js' }, { label: 'Sistemas de juego' }, { label: 'Leaflet' }, { label: 'OpenStreetMap' }] },
        { name: 'Lanzar y medir', items: [{ label: 'Lighthouse' }, { label: 'Google Analytics 4' }, { label: 'Search Console' }, { label: 'GitHub Actions' }, { label: 'Playwright' }, { label: 'Semrush' }] },
      ],
    },
    work: {
      ...
      projects: [
        { title: 'Avi Salud', type: 'Sitio web y sistema para salud', tags: ['Sitio web', 'Sistemas', 'Salud'], statement: 'La misma experiencia de cuidado, afuera y adentro de la empresa.', body: 'Desde Estudio Ve construimos el sitio público y un sistema interno para una empresa de salud domiciliaria de Mar del Plata. En la web ordenamos planes, cartilla, prestaciones y contenido educativo; el sistema centraliza turnos, rutinas, clientes, empleados y movimientos de dinero.', outcome: 'Una experiencia más clara para las familias y una operación más ordenada para el equipo.', links: [{ label: 'avisalud.com.ar', href: 'https://www.avisalud.com.ar/' }] },
        ...
        { title: 'Pelotita', type: 'Resultados de fútbol y ligas de fantasía', tags: ['Producto propio', 'Datos', 'Scraping', 'SEO', 'AdSense'], statement: 'Datos del fútbol ordenados, resultados al día y ligas de fantasía.', body: 'Pelotita junta datos de varias fuentes, normaliza equipos, torneos y partidos, y usa esa base para crear ligas de fantasía entre usuarios. Detrás hay scraping, SEO y herramientas de automatización para las notas y el blog. Además tuve que optimizar bastante el lado de DevOps — caché, consultas y deploys — para que nada se caiga a medida que los datos crecen.', outcome: 'Una plataforma de fútbol rápida y confiable, con la monetización pensada como parte del producto.', stats: ['10k+ partidos procesados', 'Varias fuentes de datos normalizadas', 'Ligas de fantasía entre usuarios'], links: [{ label: 'demo en vivo', href: 'https://pelotita-football-platform-three.vercel.app/' }] },
        { title: 'Harmonica', type: 'Product Engineer · Liderazgo técnico', tags: ['Liderazgo', 'WordPress', 'Shopify', 'Next.js', 'SEO'], statement: 'Más de diez clientes, más de diez negocios y la responsabilidad entera en mí.', body: 'En Harmonica trabajé como Product Engineer y asumí el liderazgo técnico de proyectos para más de diez clientes. Construí, mantuve y mejoré desde tiendas en WordPress y Shopify hasta productos con Next.js: e-commerce, wellness, marcas personales y sitios corporativos. Coordiné prioridades, decisiones técnicas y entregas mientras sostenía varios sitios al mismo tiempo. Además fue mi único proyecto en inglés, así que aprendí tanto del idioma como de los stacks.', outcome: 'Aprendí a liderar, comunicarme con clientes, entrar rápido en stacks ajenos y entregar sin frenar lo que ya estaba funcionando.', links: [{ label: 'katysaeger.co', href: 'https://www.katysaeger.co/' }, { label: 'harmonica.co', href: 'https://harmonica.co/' }, { label: 'evandr.co', href: 'https://www.evandr.co/' }, { label: 'twotailspetcompany.com', href: 'https://twotailspetcompany.com' }] },
        { title: 'Smithii', type: 'Ecosistema de productos Web3', tags: ['Frontend', 'Web3', 'Producto', 'Scrum', 'Chakra UI', 'APIs'], statement: 'Construí para usuarios masivos siendo junior, y fue el proyecto que más me enseñó.', body: 'Pasé casi dos años metido en un ecosistema Web3 que no paraba. Trabajé en las herramientas públicas para crear tokens, liquidez, airdrops y más; en el software interno de gestión; y en un staking builder que lanzamos como producto propio. Mucho frontend, integraciones blockchain, muchísimas APIs, usuarios masivos y flujos de datos que tenían que mantenerse rápidos y confiables. Tratamos con clientes, contratiempos incluidos, y también aprendí a trabajar en equipo con Scrum, organizar entregas en Jira y coordinar funcionalidades de punta a punta.', outcome: 'Aprendí a moverme en productos complejos, optimizar antes de que aparezcan los problemas y construir en equipo sin perder de vista al usuario.', links: [{ label: 'smithii.io', href: 'https://smithii.io/' }, { label: 'stake.smithii.io', href: 'https://stake.smithii.io/' }] },
        { title: 'Claridad', type: 'Mapa colaborativo de seguridad', tags: ['Mapas', 'APIs', 'Hackathons', 'OpenStreetMap', 'WebSockets'], statement: 'Un mapa para los barrios de Mar del Plata.', body: 'En un equipo chico construimos un producto de seguridad colaborativa con reportes geolocalizados, comunidades, alertas en tiempo real y un botón de pánico. Combinamos datos de ubicación con varias APIs, lo llevamos a hackathons, probamos la idea en público y seguimos iterando.', outcome: 'Un producto cívico útil, moldeado por trabajo en equipo, APIs e iteración rápida. No continuó por cuestiones económicas de la empresa.' },
        { title: 'Stockeo', type: 'SaaS de inventario', tags: ['Next.js', 'Java', 'Mercado Pago'], statement: 'Mi primer SaaS, construido con mi socio del estudio.', body: 'Stockeo nació como una forma práctica de generar ingresos recurrentes para Estudio Ve. Construimos un backend en Java, un frontend en Next.js y suscripciones con Mercado Pago alrededor de un flujo simple de inventario para comercios chicos.', outcome: 'Una base sólida de SaaS con decisiones de producto, pagos y negocio incluidas.', links: [{ label: 'stockeo.app', href: 'https://www.stockeo.app/' }] },
        { title: 'Simulador presidencial', type: 'Juego independiente', tags: ['Game Design', 'Sistemas', 'TypeScript', 'Hobby'], statement: 'El juego de mi vida y el más raro.', body: 'Un juego presidencial bizarro que estoy construyendo entre amigos. Es un hobby, una salida creativa y un desafío técnico enorme donde aprendo sobre mecánicas de juego, colaboración, diseño de sistemas y muchísimas áreas que estoy descubriendo que me gustan.', outcome: 'Un lugar para experimentar con libertad y aprender cosas que el trabajo comercial rara vez enseña.' },
        { title: 'Busy', type: 'Marca de streetwear', tags: ['E-commerce', 'SEO', 'Marca'], statement: 'Mi primer negocio fue uno de los proyectos en los que más aprendí.', body: 'Creé y manejé una marca de ropa de punta a punta: la tienda online con pagos integrados, el contenido, las APIs, el diseño y los eventos. Innové en el contenido y en la forma de presentar la marca, y aprendí lo que implica manejar un e-commerce tanto en tecnología como en negocio. Sin local físico, Busy rankeó en búsquedas de ropa en Mar del Plata y hasta apareció en resultados de búsqueda con IA.', outcome: 'Experiencia integral en negocio, integraciones, pagos, SEO, diseño y comunidad.' },
      ],
    },
    growth: {
                ...
                <div className="project-copy">
                  ...
                  {'links' in project && project.links ? (
                    <div className="project-links">{project.links.map(link => (
                      <a key={link.href} href={link.href} target="_blank" rel="noreferrer">{link.label}<span aria-hidden>↗</span></a>
                    ))}</div>
                  ) : null}
                </div>
...
alert("¿Qué operación deseas realizar?");`}</code></pre>
          ...
          <figure className="origin-artifact origin-artifact-lacremerie">
            <img src={images.lacremerie} alt="LaCremerie digital menu for an ice-cream shop" loading="lazy" />
            <figcaption><span>{t.notes.artifactLacremerie}</span></figcaption>
          </figure>
          <figure className="origin-artifact origin-artifact-viandas">
            <img src={images.viandas} alt="Viandas Fitness landing page with weekly meal plans" loading="lazy" />
            <figcaption><span>{t.notes.artifactViandas}</span></figcaption>
          </figure>
